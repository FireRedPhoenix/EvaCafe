...
<head>
    ...
    <meta name="keywords" content="Coffee House Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template,
...
<div class="login">
    <div class="container">
        ...
        <p class="animated wow slideInUp" data-wow-delay=".5s"><a
                href="${pageContext.request.contextPath}/LogInOutServlet?type=register">这里注册</a> (或) 返回主页
